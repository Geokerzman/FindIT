      ...
      <div class="card card-body mt-5">
        ...
        <form action="<?php echo URLROOT; ?>/users/register" method="post">
          <div class="form-group">
            ...
            <input type="text" name="name" id = "allInput" class="form-control form-control-lg <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['name']; ?>">
          ...
          <div class="form-group">
            ...
            <div id="errorContainer"></div>
            <input type="password" name="confirm_password" id = "allInput" class="form-control form-control-lg <?php echo (!empty($data['confirm_password_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['confirm_password']; ?>">
            <span class="invalid-feedback"><?php echo $data['confirm_password_err']; ?></span>
          </div>

          <div class="row mt-5">
            <div class="col">
              <input type="submit" value="Register" id ="submit-btn" class="btn btn-success btn-block">
            </div>
            <div class="col">
